...
import StudentManager.Query;

import java.awt.color.*;
import java.sql.*;
public class Update_tea extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(i==n){
			int choose=JOptionPane.showConfirmDialog(this, "请确保你的工号号是正确的,否则会更新失败！！！如果工号错误"
					+ "请先删除再添加","消息对话框",JOptionPane.WARNING_MESSAGE);
			if(choose==JOptionPane.YES_OPTION){
				Update update=new Update();
				update.setTableName("student");
